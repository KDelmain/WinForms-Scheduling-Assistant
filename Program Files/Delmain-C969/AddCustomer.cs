...
namespace Delmain_C969
{
    public partial class AddCustomer : Form
    {
        ...
        private void addAddress()
        {
            ...
            MySqlCommand cmd = new MySqlCommand($"INSERT INTO address VALUES ('{addressID}', '{addressTB.Text}','{address2TB.Text}','{city}','{postalTB.Text}','{phone.ToString()}', '{DateTimeHandler.timestamp()}', '{User.Username}', '{DateTimeHandler.timestamp()}', '{User.Username}' )", con);
        ...
        private void addCustomer()
        {
            ...
            MySqlCommand cmd = new MySqlCommand($"INSERT INTO customer VALUES ('{custID}', '{nameTB.Text}','{addressID}', 1, '{DateTimeHandler.timestamp()}', '{User.Username}', '{DateTimeHandler.timestamp()}', '{User.Username}' )", con);
