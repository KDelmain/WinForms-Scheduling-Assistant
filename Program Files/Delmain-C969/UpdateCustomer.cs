...
namespace Delmain_C969
{
    public partial class UpdateCustomer : Form
    {
        ...
        private void updateAddress()
        {
            ...
            MySqlCommand cmd = new MySqlCommand($"UPDATE address SET address = '{addressTB.Text}', address2 = '{address2TB.Text}', cityId = '{city}', postalCode = '{postalTB.Text}', phone = '{phone.ToString()}', lastUpdate = '{DateTimeHandler.timestamp()}', lastUpdateBy = '{User.Username}' WHERE addressId = '{addressID}'", con);
        ...
        private void updateCustomer()
        {
            ...
            MySqlCommand cmd = new MySqlCommand($"UPDATE customer SET customerName = '{nameTB.Text}', lastUpdate = '{DateTimeHandler.timestamp()}', lastUpdateBy = '{User.Username}' WHERE customerId = '{CustomerRecords.custID}'", con);
