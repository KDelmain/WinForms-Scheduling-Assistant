...
namespace Delmain_C969
{
    public partial class UpdateAppointment : Form
    {
        ...
        private bool validateForm()
        {
            ...
            //check that app is not outside business hours (8:00 - 17:00)
            DateTime businessOpen = DateTime.Today.AddHours(8); // 8am
        ...
        private void updateAppointment()
        {
            ...
            MySqlCommand cmd = new MySqlCommand($"UPDATE appointment SET customerId = '{custIDTB.Text}', type = '{typeTB.Text}', start = '{DateTimeHandler.toUTCTime(startPicker.Text)}', end = '{DateTimeHandler.toUTCTime(endPicker.Text)}', lastUpdate = '{DateTimeHandler.timestamp()}', lastUpdateBy = '{User.Username}' WHERE appointmentId = '{Main.appID}'", con);
