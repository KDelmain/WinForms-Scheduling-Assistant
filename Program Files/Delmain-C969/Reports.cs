...
namespace Delmain_C969
{
    public partial class Reports : Form
    {
        ...
        private void generateReport()
        {
            ...
            {
                query = "SELECT userId AS Consultant, DATE_FORMAT(start, \'%Y-%c-%d %T\') AS 'Start Time', DATE_FORMAT(end, \'%Y-%c-%d %T\') AS 'End Time', appointmentId AS 'Appointment ID', title as Appointment FROM appointment ORDER BY userId, start";
            }
